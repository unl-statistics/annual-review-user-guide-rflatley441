...
You may want to spend a bit of time showing how to decide on the linear model, identify the design space, etc.

I find it helpful to link to different options from the Big Book of R (google it) to provide some of the background knowledge.
