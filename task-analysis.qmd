...
While following the guide, users should also be read to make decisions that may not have the completly right answers:
...
The final step of the task is not just accepting whatever design the algorithm proposes, but using these evaluations to reach a design that is both defensible statistically and alsop workable
